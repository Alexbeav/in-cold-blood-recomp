...
static const PsxrecompCodegenHostConfig kCodegenConfig = {
    .display_name = "in-cold-blood-",
    .project_root_env = "IN_COLD_BLOOD_RECOMP_PROJECT_ROOT",
    .build_dir_env = "IN_COLD_BLOOD_RECOMP_BUILD_DIR",
    .force_setup_env = "IN_COLD_BLOOD_RECOMP_FORCE_SETUP",
    .psxrecomp_cli_relpath = "psxrecomp/psxrecomp_cli.py",
    .seed_cfg_relpath = "game.toml",
    .game_toml_relpath = "game.toml",
    .gen_marker_relpath = "generated/SLUS_012.94_dispatch.c",
    .build_dir_name = "build-release",
    .cmake_target = "psx-runtime",
    .exe_basename = "in_cold_blood__Recompiled",
    .prepare_note =
