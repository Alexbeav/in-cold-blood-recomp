# In Cold Blood knowledge report

- Date: 2026-08-31
- Retail identity: USA NTSC-U `SLUS-01294`, `SLUS-01314`
...
The source now uses `In_Cold_Blood_Recompiled` as the only setup executable name. The batch source
