# In Cold Blood release feasibility
...
The supported serial set is $(@{ordinal=25; slug=in-cold-blood; title=In Cold Blood; serials=System.Object[]; expected_disc_count=2; identity_complete=True; risks=System.Object[]}.serials -join ', '). The package uses
