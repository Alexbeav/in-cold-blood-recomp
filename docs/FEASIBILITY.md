...
The supported serial set is `SLUS-01294`, `SLUS-01314`. The package uses
...
The corrected source uses `In_Cold_Blood_Recompiled` for CMake, the setup relaunch, and packaging.
