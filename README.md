# In Cold Blood Recompiled
<!-- retcomm-readme-metrics -->
[![GitHub downloads (all assets, all releases)](https://img.shields.io/github/downloads/Alexbeav/in-cold-blood-recomp/total)](https://github.com/Alexbeav/in-cold-blood-recomp/releases)
[![GitHub downloads (latest release)](https://img.shields.io/github/downloads/Alexbeav/in-cold-blood-recomp/latest/total)](https://github.com/Alexbeav/in-cold-blood-recomp/releases/latest)
[![GitHub release](https://img.shields.io/github/v/release/Alexbeav/in-cold-blood-recomp)](https://github.com/Alexbeav/in-cold-blood-recomp/releases/latest)
<!-- /retcomm-readme-metrics -->

Static recompilation of **In Cold Blood** built on
[psxrecomp](https://github.com/Alexbeav/psxrecomp) and
[recomp-ui](https://github.com/mstan/recomp-ui).

A native recompilation setup host for In Cold Blood.
...
Zip prefix for CI artifacts: `In-Cold-Blood-Recomp`.
...
The `v0.3.3` source uses `In_Cold_Blood_Recompiled` in CMake, the setup relaunch, and the packager.
